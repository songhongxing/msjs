...
public enum Daoju {
    ...
    XSD("洗髓丹","重置武将的属性加点",0, 100,1000),
    YJJ("易筋经","提高武将的某个属性等级上限",0, 100,1000),
    HJ("号角","盟战时使用，提高部队攻击力",0, 100,1000),
    JN("锦囊","获取一个计谋",0, 100,1000),
    ZBX("装备箱","获取一件随机普通装备",0, 100,1000),
    SBX("神兵箱","有概率获取一件史诗装备",0, 100,1000),
    ...
    SJF("瞬建符","建筑直接升级",0, 100,1000),
    GJL("神行攻坚令","提高20%的部队攻击力,缩短50%的行军时间",0, 100,1000),
    MZP("免战牌","使用后可让城市8小时内不受攻击，只能在城市没有军情的时候使用",1, 100,1000),
    SXS("四星石","可以让三星美女提高到四星",0, 100,1000),
    WXS("五星石","可以让四星美女提高到五星",0, 100,1000),
    LXS("六星石","可以让五星美女提高到六星",0, 100,1000),
    XXZY("小箱资源","木、石、铁、粮各增加50000",1, 100,1000),
    DXZY("大箱资源","木、石、铁、粮各增加200000",1, 100,1000),
    GMK("改名卡","可以修改城池、武将、美女的名字",1, 100,1000);
