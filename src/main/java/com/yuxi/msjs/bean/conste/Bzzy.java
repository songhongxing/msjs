...
//    GB("工兵",5800,5300,7200,5500,1,0,1200,0,40,250);
    BB("步兵",120,100,180,40,1,40,2,40,20,60),
    QB("枪兵",244,260,308,100,2,60,3,75,78,75),
    NB("弩兵",260,216,167,60,2,20,4,26,85,66),
    QQ("轻骑",500,450,350,100,3,120,6,120,48,120),
    HQ("虎骑",550,640,800,180,4,64,7,200,80,102),
    CH("斥候",140,160,20,40,1,0,3,0,20,150),
    ZQ("重骑",466,374,323,120,3,35,6,45,160,115),
    CC("冲车",900,360,500,70,3,0,10,60,30,40),
    TSC("投石",950,1350,600,90,6,0,10,75,60,30),
    GB("工兵",5800,5300,7200,5500,1,0,10,0,40,250);
